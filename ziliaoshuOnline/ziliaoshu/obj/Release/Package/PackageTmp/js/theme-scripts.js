/*
 * Title:   Ailvw | Responsive HTML5 Travel Template - Main Javascript file
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Ailvw - home" href="index.html"><img alt="" src="images/logo.png"></a></h1>').insertBefore('.chaser .menu');
...
// login box
tjq("body").on("click", ".Ailvw-signup-box .signup-email", function(e) {
    e.preventDefault();
    tjq(this).closest(".Ailvw-signup-box").find(".simple-signup").hide();
    tjq(this).closest(".Ailvw-signup-box").find(".email-signup").show();
    tjq(this).closest(".Ailvw-signup-box").find(".email-signup").find(".input-text").eq(0).focus();
});
